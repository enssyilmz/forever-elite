      ...
      <div className="bg-white rounded-lg shadow-xl max-w-sm sm:max-w-md w-full p-4 sm:p-6">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-responsive-base font-semibold text-gray-900">{title}</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mb-4 sm:mb-6">
          <p className="text-responsive-sm text-gray-600 mb-2">{message}</p>
          {itemName && (
            <div className="bg-gray-50 p-2 sm:p-3 rounded-md">
              <p className="text-responsive-sm font-medium text-gray-900">{itemName}</p>
            </div>
          )}
