  ...
  return (
    <div className="min-h-screen py-8 md:py-16 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-4 md:p-8">
        <h1 className="text-responsive-xl md:text-responsive-2xl font-bold text-gray-900 mb-6 md:mb-8">Terms of Service</h1>
        
        <div className="space-y-4 md:space-y-6 text-gray-700">
          <section>
            <h2 className="text-responsive-base md:text-responsive-lg font-semibold text-gray-800 mb-3 md:mb-4">1. Agreement to Terms</h2>
            <p className="text-responsive-sm">By accessing our website and using our services, you agree to be bound by these Terms of Service and all applicable laws and regulations.</p>
          </section>
          ...
          <section>
            <h2 className="text-responsive-base md:text-responsive-lg font-semibold text-gray-800 mb-3 md:mb-4">3. Services</h2>
            <p className="mb-3 md:mb-4 text-responsive-sm">We provide fitness programs and related services. By purchasing our programs, you acknowledge:</p>
          ...
          <section>
            <h2 className="text-responsive-base md:text-responsive-lg font-semibold text-gray-800 mb-3 md:mb-4">4. Payment Terms</h2>
            <p className="mb-3 md:mb-4 text-responsive-sm">By purchasing our services:</p>
            <ul className="list-disc pl-4 md:pl-6 space-y-2 text-responsive-sm">
